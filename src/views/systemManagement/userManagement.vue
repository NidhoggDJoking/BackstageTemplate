    ...
    <div class="table-list">
      <div class="search">
        <div class="inline-block">
          <span class="demonstration">登陆账号:</span>
        ...
        <div class="inline-block">
          <span class="demonstration">所在部门:</span>
          <el-select v-model="form.type" placeholder="所在部门 ">
            <el-option label=" 系统管理组 " value="sfz"></el-option>
            <el-option label=" 测试 " value="hz"></el-option>
            <el-option label=" 测试用户组 " value="ga"></el-option>
          </el-select>
        </div>
